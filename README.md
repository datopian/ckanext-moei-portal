...
**TODO:** Document any optional config settings here. For example:
	...
	# (optional, default: 24).
	ckanext.fcscopendata.some_setting = some_default_value


## Developer installation

To install ckanext-fcscopendata for development, activate your CKAN virtualenv and
do:
...
## Releasing a new version of ckanext-fcscopendata

If ckanext-fcscopendata should be available on PyPI you can follow these steps to publish a new version:
